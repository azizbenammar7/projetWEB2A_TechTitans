...
// Récupérez l'ID du pack à partir de la requête GET
$idPack = $_GET['idPack'] ?? null;

// Vérifiez si l'ID du pack est valide
if ($idPack !== null) {
    // Obtenez les avis pour le pack spécifié
    $avisParPack = $avisC->afficheAvisParPack($idPack);
?>

    <html>
    <body>
        <h1>Liste des Avis pour le Pack ID <?php echo $idPack; ?></h1>
        ...
        <table border="1" align="center" width="70%">
            ...
            <?php foreach ($avisParPack as $avis) { ?>
                <tr>
