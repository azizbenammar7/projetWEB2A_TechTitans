...
if (
    ...
    if (
        ...
        if ($userC->emailExists($_POST['email'])) {
            ...
            $activation_link = "http://localhost/diazeninteg/views/activate-account.php?token=$activation_token_hash";
            ...
            try {
                ...
                $mail->addAddress($_POST['email']); // Définir l'adresse e-mail du destinataire
    
                $mail->Subject = "Activer votre compte";
                $mail->Body = "Merci de vous être inscrit chez DiaZen ! Cliquez sur le lien suivant pour activer votre compte: $activation_link";
