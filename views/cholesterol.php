    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="analysis-entry">
                                ...
                                <p><strong>Valeur du cholesterol:</strong>
                                    <?= $medicament['chol'] != 0 ? $medicament['chol'] : 'not provided'; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <a href="cholesterol_chart.php?idfiche=<?= $idfiche ?>">Graphic d'evolution de la glycemie postprondiale</a>
                </div>
            </div>
        </div>
    </div>
