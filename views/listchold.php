...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $filteredMedicaments = $medicamentController->listMedicamentbycholesterold();
}
$historicalData = [];
for($i = 6; $i >= 0; $i--) {
...
$totalPages = ceil(count($filteredMedicaments) / $recordsPerPage);
...
$filteredMedicaments = array_slice($filteredMedicaments, $offset, $recordsPerPage);
?>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="addMedicament.php">
                            <i class="fa fa-plus-circle fa-3x"></i> Ajouter une nouvelle historique
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form method="post" action="">
                                    ...
                                    <button type="button" onclick="window.location.href='listMedicament.php'">Reset
                                        Filter</button>
                                        <br>
                                    <label for="">Sort by: </label>
                                    <button type="button" onclick="window.location.href='listglyc.php'">Glycemie: croissant</button>
                                    <button type="button" onclick="window.location.href='listglycd.php'">Glycemie: decroissant</button>
                                    <button type="button" onclick="window.location.href='listchol.php'">Cholesterol: croissant</button>
                                    <button type="button" onclick="window.location.href='listchold.php'">Cholesterol: decroissant</button>
                                    <button type="button" onclick="window.location.href='listcreat.php'">Creatinine: croissant</button>
                                    <button type="button" onclick="window.location.href='listcreatd.php'">Creatinine: decroissant</button>
