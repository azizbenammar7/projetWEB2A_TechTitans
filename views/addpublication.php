                        ...
                        <form action="" method="POST">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control border-0" placeholder="nom" style="height: 55px" id="nom" name="nom" value="<?php echo $user['nom']; ?>" readonly />
                                    <?php if (!empty($errorNom)) : ?>
                                        <div style="color: red;"><?php echo $errorNom; ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control border-0" placeholder="prénom" style="height: 55px" name="prenom" id="prenom" value="<?php echo $user['prenom']; ?>" readonly />
                                    <?php if (!empty($errorPrenom)) : ?>
                                        <div style="color: red;"><?php echo $errorPrenom; ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="col-12 col-sm-6">
                                <input type="text" class="form-control border-0" placeholder="prénom" style="height: 55px" name="role" id="role" value="<?php echo $user['role_user']; ?>" readonly />
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-row" id="user-email" data-target-input="nearest">
                                        <input type="email" class="form-control border-0 datetimepicker-input" placeholder="Email" data-target="#email" data-toggle="email" style="height: 55px" name="email"value="<?php echo $user['email']; ?>" readonly />
                                    </div>
