...
if (isset($_GET['q']) && !empty($_GET['q'])) {
    $searchTerm = $_GET['q'];
    $searchResult = $medicamentController->searchMedicament($searchTerm);

    // Trouver l'index du médicament recherché dans la liste complète
    $index = array_search($searchTerm, array_column($medicaments, 'nom'));

    // Si le médicament est trouvé, déplacer au début
    if ($index !== false) {
        $medicament = $medicaments[$index];
        unset($medicaments[$index]);
        array_unshift($medicaments, $medicament);
    }
}
?>
...
<body>
                ...
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <div id="pharmacie_cadre">
                        <select name="type_medicament" id="type_medicament">
                            ...
                            <option value="medicament">pilule</option>
                            <option value="appareille">piqûre</option>
                            <option value="picture">appareillage</option>
                        </select>
                        <input type="text" id="searchInput" name="q" placeholder="Rechercher..." style="width: 400px; height: 40px; font-size: 16px;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item position-relative rounded overflow-hidden" data-type="<?= strtolower($medicament['typ']); ?>">
                    <div class="overflow-hidden">
                        ...
                        <img class="img-fluid" src="<?= $medicament['piece_jointe']; ?>" alt="Medicament Image">
                    </div>
    ...
    <script>
        document.getElementById('searchInput').addEventListener('input', function () {
            ...
            var medicamentItems = document.querySelectorAll('.team-item');

            medicamentItems.forEach(function (item) {
                var medicamentName = item.querySelector('.team-text h5').innerText.toLowerCase();

                if (medicamentName.includes(searchValue)) {
