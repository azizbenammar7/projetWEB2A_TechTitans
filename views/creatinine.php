    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1>Analyses de creatinine serique</h1>
            </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="analysis-entry">
                                ...
                                <p><strong>Valeur de la creatinine serique:</strong>
                                    <?= $medicament['nom'] != 0 ? $medicament['nom'] : 'not provided'; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <a href="creatinine_chart.php?idfiche=<?= $idfiche ?>">Graphic d'evolution de la glycemie postprondiale</a>
                </div>
            </div>
        </div>
    </div>
