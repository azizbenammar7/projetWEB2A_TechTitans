    ...
    public function generatePDF1($medicament) {
        ...
        try {
           ...
           $mail->addReplyTo('gastonishere1000@gmail.com', 'Information');
            ...
            // Content
            $mail->isHTML(true);
            $mail->Subject = 'Notification: Nouvelle analyse ajoutée avec succès';
            $mail->Body = '<p>Bonjour,</p><p>Une nouvelle analyse a été ajoutée avec succès pour la fiche '.$medicament->getidfiche().'.</p><p>Merci.</p>';
            $mail->AltBody = 'Bonjour, Une nouvelle analyse a été ajoutée avec succès pour la fiche '.$medicament->getidfiche().'. Merci.';
