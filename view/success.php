...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($IDuser) && !empty($IDpackuser) && isset($payed)) {
        $abonnement = new Abonnement($IDuser, $IDpackuser, $dateActuelle, $payed);
        ...
        try {
            ...
            $mail->Password = 'karimezelvampirex22';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS


            $mail->setFrom('calfados22@gmail.com', 'karim');
            $mail->addAddress('mellouli.youssef11@gmail.com', 'mellouli.youssef11@gmail.com'); // Adresse e-mail de l'utilisateur
