...
$idfichees1 = $TypeController->listidfichee();
$idfichees2 = $TypeController->listidfichee();
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <div class="analysis-entry">
                            <h3>Analyse de la Glycémie postprandiale</h3>
                        </div>
                        <!-- Form for entering patient ID -->

                        <div class="col-12 col-sm-6">
                            <form action="glycemie.php" method="GET">

                                <select class="form-select border-0" style="height: 55px" id="idfiche" name="idfiche"
                                    required>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <div class="analysis-entry">
                            <h3>Analyse du Cholesterol</h3>
                        </div>
                        <!-- Form for entering patient ID -->
                        <form action="cholesterol.php" method="GET">
                            <select class="form-select border-0" style="height: 55px" id="idfiche" name="idfiche"
                                required>
                                <option selected>Nom & Prenom</option>

                                <?php foreach($idfichees1 as $idfichee) { ?>
                                    <option value="<?php echo $idfichee['id']; ?>">
                                        <?php echo $idfichee['idfiche']; ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus text-white me-3"></i>Read
                                More</button>
                        </form>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <div class="analysis-entry">
                            <h3>Analyse de la Créatinine sérique</h3>
                        </div>
                        <!-- Form for entering patient ID -->
                        <form action="creatinine.php" method="GET">
                            <select class="form-select border-0" style="height: 55px" id="idfiche" name="idfiche"
                                required>
                                <option selected>Nom & Prenom</option>

                                <?php foreach($idfichees2 as $idfichee) { ?>
                                    <option value="<?php echo $idfichee['id']; ?>">
                                        <?php echo $idfichee['idfiche']; ?>
                                    </option>
                                <?php } ?>
