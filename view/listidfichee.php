            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <a href="addidfichees.php">
                            <i class="fa fa-plus-circle fa-3x"></i> Ajouter une fiche
                        </a>
                        <a href="ajoutfiche.php">
                            <i class="fa fa-plus-circle fa-3x"></i> Ajouter une fiche par le frontoffice
                        </a>
                    </li>
                </ul>
            </div>
