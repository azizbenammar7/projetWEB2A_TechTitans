    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1>Analyses de la Glycémie postprondiale</h1>
            </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="analysis-entry">
                                <h3>Date de l'analyse:
                                    <?= $medicament['date_ajout']; ?>
                                </h3>
                                <p><strong>Valeur de la glycemie postprondiale:</strong>
                                    <?= $medicament['glyc'] != 0 ? $medicament['glyc'] : 'not provided'; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <a href="glycemic_chart.php?idfiche=<?= $idfiche ?>">Graphic d'evolution de la glycemie postprondiale</a>
                </div>
    ...
    <script type="text/javascript">
        window.onload = function () {
            var chart = new CanvasJS.Chart("chartContainer", {
                title:
                {
                    text: "Graphe des Analyses de la Glycémie postprandiale "
                },
                data: [
                    {
                        type: "area",
                        dataPoints: [
                            { x: new Date(2023, 0o2, 20), y: 120 },
                            { x: new Date(2023, 0o2, 28), y: 130 },
                            { x: new Date(2023, 0o3, 15), y: 90 }
                        ]
                    }
                ]
            });
