            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="accueil_forum.html" class="dropdown-item ative">Tous les publications</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="ajouthistorique.php" class="dropdown-item active">Ajout d'analyses</a>
                        <a href="ajoutfiche.php" class="dropdown-item ">Ajouter une fiche</a>
                    ...
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6" >
                                    <input type="text" id="glyc" name="glyc"
