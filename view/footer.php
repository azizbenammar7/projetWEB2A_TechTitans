...
<div class="container-fluid bg-dark text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <script>
        function updateAttachmentLabel() {
            ...
            var fileName = fileInput.value.split('\\').pop(); // Obtient le nom du fichier
        
            if (fileName) {
                attachmentLabel.innerText = fileName; // Met à jour le texte avec le nom du fichier choisi
            } else {
                attachmentLabel.innerText = 'Aucun document choisi'; // Remet le texte par défaut si aucun fichier choisi
            }
        }
        </script>
</body>
