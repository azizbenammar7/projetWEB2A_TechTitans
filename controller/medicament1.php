...
class MedicamentController1
{
    ...
    {
        $sql = "SELECT m.*, t.typ as type_nom FROM medicament1 m
    ...
    {
        $sql = "SELECT * FROM medicament1 WHERE nom LIKE :searchTerm";
 ...
 public function filterMedicamentByType($type)
 {
    ...
    {
        $sql = "DELETE FROM medicament1 WHERE id = :id";
        $db = Config::getConnexion();
        $req = $db->prepare($sql);
        $req->bindValue(':id', $id);
    ...
    {
        $sql = "INSERT INTO medicament1 (nom, typ, lieu, dispon, date_ajout, piece_jointe)  
    ...
    {
        $sql = "SELECT * FROM medicament1 WHERE id = :id";
        $db = Config::getConnexion();
        try {
            $query = $db->prepare($sql);
...
{
    $sql = "SELECT COUNT(*) as total FROM medicament1";
...
public function filterMedicamentByNameAndLieu($nom, $lieu)
{
    try {
        ...
        $query = "SELECT * FROM medicament1 WHERE nom = :nom AND lieu = :lieu";
